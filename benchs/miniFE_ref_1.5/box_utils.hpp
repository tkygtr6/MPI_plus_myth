...
{
  bool x_neighbor = (box1[0][1] == box2[0][0]) || (box1[0][0] == box2[0][1]) || (box1[0][0] == box2[0][0]) || (box1[0][1] == box2[0][1]);

  bool y_neighbor = (box1[1][1] == box2[1][0]) || (box1[1][0] == box2[1][1]) || (box1[1][0] == box2[1][0]) || (box1[1][1] == box2[1][1]);

  bool z_neighbor = (box1[2][1] == box2[2][0]) || (box1[2][0] == box2[2][1]) || (box1[2][0] == box2[2][0]) || (box1[2][1] == box2[2][1]);
...
//}
    if (!is_neighbor(box, box_i)) continue;
//    ++num_neighbors;

...
void broadcast_parameters(Parameters& params)
{
  ...
  int iparams[num_int_params] = {params.nx, params.ny, params.nz, params.numthreads, params.mv_overlap_comm_comp, params.use_locking, params.elem_group_size, params.use_elem_mat_fields, params.verify_solution};
